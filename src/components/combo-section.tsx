  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="glass-panel relative overflow-hidden rounded-[2rem] border border-white/12 bg-white/[0.04] p-8 shadow-[0_26px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:p-10 lg:p-12">
          <div
          ...
          <div
            className="pointer-events-none absolute inset-y-0 left-[-30%] w-1/3 -skew-x-12 bg-[linear-gradient(90deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.12)_50%,rgba(255,255,255,0)_100%)] opacity-70 blur-xl"
            aria-hidden
          />
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="rounded-3xl border border-white/12 bg-white/[0.06] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur-xl sm:p-8">
